      ...
      <div class="modal-body">
           <form action="#" id="form" method="post"> 
            <div class="form-group">
               ...
               <input  required type="text" class="form-control"  id ="firstname" name="username"  placeholder="Enter firstname" >
               <small>Error message</small>
            </div>
            <div class="form-group">
               <label for="lastname">Lastname</label>
               <input required type="text" class="form-control" id="lastname" name="lastname" placeholder="Enter Lastname">
            </div>
            <div class="form-group">
               <label for="email">Email</label>
               <input required type="text" class="form-control" id="email" name="email" placeholder="Enter Email id">
            </div>
            <div class="form-group">
               <label for="mobile">Mobile</label>
               <input required type="text" class="form-control" id="mobile"  name="mobile" placeholder="Enter Mobile Number">
            </div>
           </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
               ...
               <input required type="text" class="form-control"  id ="update_firstname" placeholder="Enter firstname" >
               <small>Error mesaage<small>

            </div>
            <div class="form-group">
               <label for ="update_lastname">Update_Lastname</label>
               <input required type="text" class="form-control" id="update_lastname" placeholder="Enter Lastname" >
            </div>
            <div class="form-group">
               <label for="update_email">Update_email</label>
               <input  required type="text" class="form-control" id="update_email" placeholder="Enter Email id" >
            </div>
            <div class="form-group">
               <label for="update_mobile">Update_Mobile</label>
               <input  required type="text" class="form-control" id="update_mobile" placeholder="Enter Mobile Number">
            </div>
